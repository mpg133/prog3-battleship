...
public class CoordinatePreTest {
	 ...
	 * el m̩todo set(int, int) y se comprueba con get(int) que los valores de sus 
	 ...
	 * el Coordinate que invoca al m̩todo.
	 */
	@Test  //{0,0,-70,-2,20}
	public void testAdd() {
	...
	public void testToString() {
		...
		assertEquals ("(0,0)",removeSpaces(lcoor.get(0).toString()));
		assertEquals ("(0,-70)", removeSpaces(lcoor.get(1).toString()));
		assertEquals ("(-70,-2)", removeSpaces(lcoor.get(2).toString()));
		assertEquals ("(-2,20)", removeSpaces(lcoor.get(3).toString()));
