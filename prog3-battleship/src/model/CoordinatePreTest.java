...
public class CoordinatePreTest {
	...
	public void testCoordinateConstructorCopy() {
		Coordinate c= new  Coordinate(20,30);
	...
	public void testGetSet() {
		...
		//modificamos c y comprobamos 
		c.set(0,30);
		c.set(1, 25);
		assertEquals("x==30", 30, c.get(0));
		assertEquals("x==25", 25, c.get(1));
	...
	@Test  //{0,0,-70,-2,20}
	public void testAdd() {
		Coordinate caux1 = lcoor.get(0);//(0,0)
		Coordinate caux2;
		...
		for (int i=0; i<DIM-2; i++) {	
		   ...
		   //que sumx y sumy son iguales a los componentes '0' y '1' 
		   // respectivamente de caux1.
		   assertEquals(sumx,caux1.get(0),0.01);
		   assertEquals(sumy,caux1.get(1),0.01);
		  //que el Coordinate que devuelve 'add' no es el mismo que
	      //el Coordinate que invocó al método.
	...
	public void testSubtract() {
		...
		for (int i=0; i<DIM-2; i++) {	
		  ...
		  resty += (vcoor[i+2]);
		   ...
		   //que sumx y sumy son iguales a los componentes '0' y '1' 
		   // respectivamente de caux1.
		   assertEquals(restx,caux1.get(0),0.01);
		   assertEquals(resty,caux1.get(1),0.01);
		  //que el Coordinate que devuelve 'add' no es el mismo que
	      //el Coordinate que invocó al método.
		   assertNotSame(caux1,caux2);
